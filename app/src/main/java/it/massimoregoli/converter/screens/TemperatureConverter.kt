...
fun TemperatureConverter(viewModel: TemperatureViewModel) {
    val strCelsius = stringResource(R.string.celsius)
    val strFahrenheit = stringResource(R.string.fahrenheit)
    val currentValue = viewModel.temperature.collectAsStateWithLifecycle(lifecycleOwner = androidx.compose.ui.platform.LocalLifecycleOwner.current)
    val scale = viewModel.scale.collectAsStateWithLifecycle(lifecycleOwner = androidx.compose.ui.platform.LocalLifecycleOwner.current)
